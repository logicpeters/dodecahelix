...
public class UserPreferences {
    ...
    public static final String KEY_IMAGE_PIXEL_WIDTH = "image.pixel.width";
    public static final String KEY_IMAGE_PIXEL_HEIGHT = "image.pixel.height";
    public static final String KEY_IMAGE_PERIOD = "image.period";
    public static final String KEY_IMAGE_PERIOD_X = "image.period.x";
    public static final String KEY_IMAGE_PERIOD_Y = "image.period.y";
